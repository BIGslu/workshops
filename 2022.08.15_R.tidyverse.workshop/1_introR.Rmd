...
Please [install R](http://www.r-project.org) and [RStudio](https://www.rstudio.com/products/rstudio/download/). See the [setup instructions][lesson0] for more details.
...
Create a directory *inside* your project directory called `data` and move the data files into this directory.
...
* Previous lession: [Setup and installation][lesson0]
