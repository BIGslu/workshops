...
* [Install R](http://www.r-project.org), a free software environment for statistical computing and graphics.
    - It is _highly recommended_ to install a pre-compiled binary distribution for your operating system -- use the links up at the top of the page linked to above!
...
If you **are not** attending a 1-hour Intro R session, please also install the following packages. If you are attending Intro R, we will cover this step during that session.
...
Check that the installed packages can be loaded.
