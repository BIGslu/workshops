...
Notice that `summarize` automatically names the column with the summary statistic based on the function used to calculate that statistic. This is not ideal as the formatting has paranthese. So we can specify a name instead.
...
These are the data we will use in our next session on plotting in `ggplot`!
