...
Install R packages by running a script in your R console in RStudio (left panel in the above image). Each workshop has an overlapping but unique list of packages. Please select the appropriate script from those below.
